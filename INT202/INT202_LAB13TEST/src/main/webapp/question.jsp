...
<div class="card">
    <c:choose>
        <c:when test="${empty question.id}">
            <div id="new-ques-form">
                <form action="edit-question" method="post">
                    <h3 class="label">Add New Question</h3>
                    <p>
                    <span class="label">Question : </span>
                    <input type="text" name="text" placeholder="Enter new question"/>
            ...
            <li>
                <div id="edit-answer-form-${ans.index}" class="hide">
                    <form action="edit-question" method="post">
                        ...
                        <input id="isCorrect-edit" type="checkbox"
                               name="isCorrect" ${answer.isCorrect == 1 ? "checked" : ""} >
                ...
                <span ${ answer.isCorrect == 1 ? 'class="correct"' : "" }>
                    ...
                    <a href="edit-question?id=${question.id}&&action=remove-answer&id=${answer.id}">Delete</a> ]
                </span>
                </div>
            </li>
